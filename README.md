...
&nbsp;
<img src="https://img.shields.io/badge/Status-Open+to+Opportunities-22c55e?style=for-the-badge&labelColor=052e16" />
</p>
...
| Medal | Competition | Position | Domain | Venue |
|:-----:|:-----------|:--------:|:-------|:------|
| 🥇 | **Scrolls'25** — National Technical Paper Presentation Contest | **1st Place** | Computer Science & Engineering | AKGEC, Ghaziabad |
| 🥈 | **Tech Fusion 2025** — Tech Think Tank Challenge | **2nd Place** | Innovation & Problem Solving | IPEM, Ghaziabad |
...
![Groq](https://img.shields.io/badge/Groq_API-FF6C37?style=for-the-badge&logo=thunder&logoColor=white)
...
**🌉 CampusBridge**
> Smart Campus Complaint & Lost-Found System

`React` `Node.js` `MongoDB` `JWT` `Cloudinary` `Nodemailer`

- 🔒 Anonymous OTP-verified complaint submission
- ⏱️ SLA tracker: 24h → 72h → 7-day escalation
- 📸 Image evidence via Cloudinary (3 per complaint)
- 📊 Recharts-powered admin analytics dashboard
...
> ML-Powered Intelligent Q&A System

`Python` `LangChain` `FAISS` `Groq API` `Gradio`

- 📄 Upload any document — ask in natural language
- 🧠 Full Retrieval-Augmented Generation pipeline
- 🔍 Semantic vector search with FAISS
- ⚡ Blazing fast Groq LLaMA inference backend
- 🖥️ Clean Gradio UI for interactive demos
...
> Full-Stack Medical Platform (MERN)

`React.js` `Node.js` `MongoDB` `Tailwind CSS`

- 🩺 Doctor profiles, hospital services & booking
- 📱 Fully responsive mobile-first design
- 📬 Appointment forms via Getform.io API
...
**🎉 CodeArambh — Hackathon Fest Platform**
> College Tech Fest Frontend

`React.js` `Axios` `Tailwind CSS` `Framer Motion`

- 📅 Event browsing, schedules & online registrations
...
```
🔷  Student Coordinator — Pathfinder Club
    ├─ Spearheaded student engagement initiatives
    ├─ Organized collaboration & communication activities
    └─ Mentored peers in professional skill-building
```
...
![Next.js](https://img.shields.io/badge/Next.js-learning-black?style=for-the-badge&logo=next.js)
![TypeScript](https://img.shields.io/badge/TypeScript-learning-3178c6?style=for-the-badge&logo=typescript&logoColor=white)
![LangGraph](https://img.shields.io/badge/LangGraph-exploring-1C3C3C?style=for-the-badge&logo=langchain&logoColor=white)
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/kanishkapal2005/kanishkapal2005/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/kanishkapal2005/kanishkapal2005/output/github-contribution-grid-snake.svg" />
  <img alt="github-snake" src="https://raw.githubusercontent.com/kanishkapal2005/kanishkapal2005/output/github-contribution-grid-snake-dark.svg" />
</picture>

> ⚙️ One-time setup: Add [Platane/snk](https://github.com/Platane/snk) GitHub Action to auto-generate the snake.
...
## <img src="https://media.giphy.com/media/LnQjpWaON8nhr21vNW/giphy.gif" width="34px"> &nbsp;Let's Connect!

<div align="center">

<a href="https://kanishka-pal.netlify.app/" target="_blank">
  <img src="https://img.shields.io/badge/🌐_Portfolio-kanishka--pal.netlify.app-7c3aed?style=for-the-badge&labelColor=1e1b4b" />
</a>
<br/><br/>
<a href="https://www.linkedin.com/in/kanishkapal2005/" target="_blank">
  <img src="https://img.shields.io/badge/LinkedIn-Kanishka%20Pal-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
</a>
&nbsp;
<a href="https://github.com/kanishkapal2005" target="_blank">
  <img src="https://img.shields.io/badge/GitHub-kanishkapal2005-181717?style=for-the-badge&logo=github&logoColor=white" />
</a>
&nbsp;
<a href="https://leetcode.com/u/kanishka-pal/" target="_blank">
  <img src="https://img.shields.io/badge/LeetCode-kanishka--pal-FFA116?style=for-the-badge&logo=leetcode&logoColor=black" />
</a>
&nbsp;
<a href="mailto:kksnehapal@gmail.com" target="_blank">
  <img src="https://img.shields.io/badge/Gmail-kksnehapal@gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
</a>
...
<!-- Footer -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0ea5e9,50:4f46e5,100:7c3aed&height=130&section=footer&text=Thanks+for+visiting!+⭐&fontSize=24&fontColor=ffffff&fontAlignY=65&animation=twinkling" />
